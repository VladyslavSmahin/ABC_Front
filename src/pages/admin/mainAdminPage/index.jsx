...
const MainAdminPage = () => {
    ...
    const isArticlesPage = location.pathname.startsWith("/admin/getAllArticles");
...
const MainAdminPage = () => {
    ...
    // Показывать форму только если НЕ на страницах списка или редактирования статьи
    const isArticlesPage = location.pathname.startsWith("/admin/getAllArticles");
    const isEditPage = location.pathname.startsWith("/admin/changeArticle/");
    const showForm = !isArticlesPage && !isEditPage;
    ...
    return (
        <div className="adminPage">
            ...
            {!showForm ? (
                <button className="swapAdminPagesBtn" onClick={handleBackToForm}>
                    Back to Form
                </button>
            ) : (
                <button className="swapAdminPagesBtn" onClick={handleGoToAllArticles}>
                    Go to All Articles
                </button>
            )}
            ...
            {showForm && (
                <form onSubmit={handleSubmit}>
                    <div className="title_dateWrapper">
                        ...
                        <div className="selectWrapper">
                            <label htmlFor="articlePlacement">
                                Выберите место размещения статьи на главной странице:
                            </label>
                            <select
                                id="articlePlacement"
                                value={data.isMainArticle}
